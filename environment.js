...
const smartedENV = {
	dev: {
		api_base_url: "https://b289-188-2-7-121.eu.ngrok.io/api",
...
const pharmaENV = {
	...
	prod: {
		...
		s3_base_url: "https://pharmanet-production.s3.eu-central-1.amazonaws.com/", // production
	},
}
...
const getEnvVars = (appName = Constants.expoConfig.extra.appName) => {
	if (__DEV__) {
